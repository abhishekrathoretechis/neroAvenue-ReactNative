...
const OtherProfileDetailsView = props => {
  ...
  const getPostData = page => {
    ...
    client
      .get(
        `user/${idDetails}/post/${postId}/all/details?type=post&page=${page}&itemSize=${itemsPerLoad}`,
      )
      .then(res => {
        setLoading(false);
    ...
    if (idState === idForShowMsg) {
      return (
        <View style={styles.renderItemContainer}>
          {!isHidden && (
            <>
              <Text style={styles.renderItemHeaderText}>
      ...
      <TouchableOpacity style={styles.RadioButtonContainer} onPress={onSelect}>
        {selected ? (
          <ImageBackground
            ...
            style={styles.RadioButtonImageBackground}>
            <Image
  ...
  const SelectReport = ({label, selected, onSelect}) => {
    return (
      <TouchableOpacity style={styles.SelectReportContainer} onPress={onSelect}>
        <Image
          source={imageConstant.leftarrow}
          style={styles.SelectReportImage}
        />
        <Text
          style={{
    ...
    <>
      ...
      <SafeAreaView style={styles.maincontainer}>
        ...
        <Modal
          ...
          backdropOpacity={0}
          style={styles.sideModalStyle}>
          <View style={styles.sideModalContainer}>
            <TouchableOpacity
              style={styles.sideModalTouchable}
              onPress={() =>
            ...
            <TouchableOpacity
              onPress={reportModal}
              style={styles.sideModalTouchableReport}>
              <Image
                source={imageConstant.report}
                style={{width: 27, height: 27}}
              />
              <Text style={styles.sideModalReportText}>Report</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        {/* hide modal visible */}
        <Modal
          ...
          backdropOpacity={0}
          style={styles.hidemodalcont}>
          <View
            style={[
              styles.sideModalContainer,
              {height: responsiveScreenHeight(40)},
            ]}>
            <Text style={styles.hidemodaltext}>
        ...
        <Modal
          ...
          {reportSelected === '' ? (
            <View
              ...
              <Text style={styles.hidemodalnewtext}>
            ...
            <View
              ...
              {reportSelected === 'Misleading or Spam' ? (
                <View style={{width: '90%'}}>
                  <Text style={styles.misleadtext}>Misleading or Spam</Text>
...
export default OtherProfileDetailsView;
const styles = StyleSheet.create({
  ...
  RadioButtonImageBackground: {width: 20, height: 20, justifyContent: 'center'},
  RadioButtonImage: {width: 12, height: 12, alignSelf: 'center'},
