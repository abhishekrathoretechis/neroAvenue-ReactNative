...
import MagzineSavedDetailsScreen from '../magzineSavedDetailsScreen/MagzineSavedDetailsScreen';
import styles from './Styles';

const MagzScrollSavedScreen = props => {
  ...
  const getMagzData = (page, isFirstTime = false) => {
    ...
    client
      .get(
        `user/savedPosts/${ppostid}/details?type=mags&page=${page}&itemSize=${itemsPerLoad}`,
      )
...
export default MagzScrollSavedScreen;
